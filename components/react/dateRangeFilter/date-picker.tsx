...
// Previously injected only into gs-date-range-filter's Lit shadow root (see components/VENDOR.md
// and the step-2 Lit-removal commit). Global now that there's no shadow DOM to scope it to.
